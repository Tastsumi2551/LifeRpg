    ...
    <div className="flex flex-col items-center gap-6 py-8 text-center">
      ...
      >
        ...
        <p className="text-text-secondary text-sm leading-relaxed max-w-xs mx-auto">
          Este es Axel, tu compañero dragón. Crece contigo a medida que subes de nivel.
        </p>
      </motion.div>
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="bg-accent/10 rounded-xl rounded-tl-none p-3">
      ...
      >
        <p>Axel evoluciona con tu nivel:</p>
